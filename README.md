...
Read PDF/EPUB/Markdown/web articles aloud in your own AI-cloned voice — trilingual (中/EN/DE) iOS reader, offline fallback
...
- **Topics:** ai, avfoundation, ios, swift, swiftui, text-to-speech, tts, voice-cloning
